...
def create_dash_app(df_w, df_g, df_r):
    ...
    def filter_data(df, query_route, query_date):
        ...
        dff = df.loc[(df['name'] == query_route)&(df['date'] == sd2_d),['updatetime','time/length[s/km]','length/time[km/h]']]
        return dff
    ...
    def update_graph(query_route, query_date):
        ...
        [trace_w_y1,trace_w_y2] = create_traces(df_w, "waze")  
        [trace_g_y1,trace_g_y2] = create_traces(df_g, "gps")
...
if __name__ == '__main__':
    [grouped_df_tt_w, grouped_df_tt_g, df_r_w] = assemble_data('16.11.2018', '24.10.2018', '25.10.2018')
